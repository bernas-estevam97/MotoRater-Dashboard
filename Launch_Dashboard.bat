...
REM --- 1. SMART CHECK: Does a local virtual environment already exist? ---
if exist "venv\Scripts\python.exe" (
    ...
    echo ==================================================
    echo.
    echo [System] Detected existing virtual environment (venv).
    set "PYTHON_EXE=venv\Scripts\python.exe"
    set "ENV_DIR=venv"
    goto :check_app_files
)

REM --- 2. Check if Portable Python is already installed ---
...
set /a current_step+=1
set "bar=[#####.]"
call :draw_progress "Installing App Dependencies (Data, Stats & UI Engines)..."
